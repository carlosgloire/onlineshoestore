            ...
            <div class="newsletter-form">
                <form action="" method="post">
                    ...
                    <div class="all-inputs">
                        <input type="text" name="categorie" placeholder="Category name"  value="<?= isset($_POST['categorie'])? ($_POST['categorie']):''?>">
                    </div>
                    <div class="all-inputs">
                        <textarea id="description" name="description" rows="4" placeholder="Category description"><?= isset($_POST['description'])? ($_POST['description']):''?></textarea>
                    </div>
